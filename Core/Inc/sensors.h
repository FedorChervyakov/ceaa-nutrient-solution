...
#define PH_SLOPE_EE_ADDR                ((uint16_t) 0x0000)
#define PH_INTCPT_EE_ADDR               ((uint16_t) 0x0008)
#define EC_SLOPE_EE_ADDR                ((uint16_t) 0x0010)
#define EC_INTCPT_EE_ADDR               ((uint16_t) 0x0018)
